...
describe('scoring', () => {
  it('counts anonymity windows with tolerance', () => { const e=[event(),event({timestamp:new Date('2026-01-06T12:00:00Z')}),event({timestamp:new Date('2025-12-20T00:00:00Z')})]; expect(estimateAnonymitySet(e,'STRK',1000000000000000000n,86400000).within24h).toBe(2); expect(estimateAnonymitySet(e,'STRK',1000000000000000000n,86400000).within7d).toBe(2); });
